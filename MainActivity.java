...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if( savedInstanceState != null ) {
            ...
            message = "आप कैसे हैं। कृपया मुझे अपनी समस्या बताएं";
    ...
    private void pressButton() {
        ...
        String mess = generateResponse(talk);
        addMessage("<Eliza> "+mess);
        t1.speak(mess, TextToSpeech.QUEUE_FLUSH, null);
        scrollToBottom();
    }
    ...
    private void initializePhrases() {
        ...
        replacer_list.add(new Replacer(Where.CONTAINS, "परिवार", 0));
        ...
        replacer_list.add(new Replacer(Where.CONTAINS, "दुख है", 1));
        ...
        replacer_list.add(new Replacer(Where.CONTAINS, "नफरत है",2));
        replacer_list.add(new Replacer(Where.CONTAINS, "नफरत करता हूं", 2));
        replacer_list.add(new Replacer(Where.CONTAINS, "नफरत करती हूं", 2));
        list_of_list_of_phrases.add( Arrays.asList( "ऐसा क्यों?", "आप इससे नफरत क्यों करते है?","नफरत करने से कुछ समाधान नहीं होने वाला है।"));
        replacer_list.add(new Replacer(Where.CONTAINS, "मुझे चाहिए", 3));
        replacer_list.add(new Replacer(Where.CONTAINS, "चाहिए मुझे", 3));
        ...
        replacer_list.add(new Replacer(Where.CONTAINS, "आप कैसे हो", 5));
        replacer_list.add(new Replacer(Where.CONTAINS, "आप कैसे हो", 5));
        replacer_list.add(new Replacer(Where.CONTAINS, "आप कैसे है", 5));
        list_of_list_of_phrases.add( Arrays.asList("में ठीक हूं। आप कैसे है?"));
        replacer_list.add(new Replacer(Where.CONTAINS, "फिर कबी मिलते है", 6));
        replacer_list.add(new Replacer(Where.CONTAINS, "फिर मिलते है कबी", 6));
        replacer_list.add(new Replacer(Where.CONTAINS, "चलो मिलते है फिर कबी", 6));
        replacer_list.add(new Replacer(Where.CONTAINS, "अब मैं चलता हूं", 6));
        replacer_list.add(new Replacer(Where.CONTAINS, "अब मैं चलती हूं", 6));
        replacer_list.add(new Replacer(Where.CONTAINS, "बाद में बात करता हूं", 6));
        replacer_list.add(new Replacer(Where.CONTAINS, "बाद में बात करती हूं", 6));
        replacer_list.add(new Replacer(Where.CONTAINS, "बाद में बात करते है", 6));
        replacer_list.add(new Replacer(Where.CONTAINS, "धन्यवाद", 6));
        replacer_list.add(new Replacer(Where.CONTAINS, "अच्छा लगा आपसे बात करके", 6));
        replacer_list.add(new Replacer(Where.CONTAINS, "अच्छा लगा आपसे", 6));
        ...
        replacer_list.add(new Replacer(Where.CONTAINS, "मुझे पसंद", 7));
        replacer_list.add(new Replacer(Where.CONTAINS, "मुझे बोहत पसंद", 7));
        replacer_list.add(new Replacer(Where.CONTAINS, "अच्छा लगता है", 7));
        replacer_list.add(new Replacer(Where.CONTAINS, "अच्छा लगा", 7));
        ...
        replacer_list.add(new Replacer(Where.CONTAINS,"बहुत बुरा", 8));
        list_of_list_of_phrases.add( Arrays.asList("इतना बुरा मत सोचिए।", "क्या ये खराब है?","इसमें कुछ गलत लगा क्या?"));
        replacer_list.add(new Replacer(Where.CONTAINS, "सुंदर", 9));
        replacer_list.add(new Replacer(Where.CONTAINS, "बढ़िया", 9));
        replacer_list.add(new Replacer(Where.CONTAINS, "अच्छा", 9));
        replacer_list.add(new Replacer(Where.CONTAINS, "लाजवाब", 9));
        replacer_list.add(new Replacer(Where.CONTAINS, "बहुत बढ़िया", 9));
        ...
        list_of_list_of_phrases.add( Arrays.asList("क्या आप अक्सर ये सोचते हैं?","क्या इसके के बारे में सोचने से दिमाग में कुछ और आता है ?",
                "आप और क्या याद कर पा रहे हैं ?", " आपने इसको को अभी ही क्यों याद किया ?"));
        replacer_list.add(new Replacer(Where.CONTAINS, "क्या तुम्हें याद है", 15));
        list_of_list_of_phrases.add( Arrays.asList("क्या आपको लगा कि मै भूल जाऊंगी?","आपको क्यों लगता है कि मुझे इसको अब याद करना चाहिए?", "आपने इस चीज का उल्लेख पहले किया है क्या?"));
        replacer_list.add(new Replacer(Where.CONTAINS, "यदि", 16));
        replacer_list.add(new Replacer(Where.CONTAINS, "अगर", 16));
        list_of_list_of_phrases.add( Arrays.asList("क्या आपको लगता है कि इसकी संभावना है।","आप ऐसा क्यों सोच रहे है?",
                "क्या आप चाहते हैं कि ऐसा हो?", "वास्तव में, अगर ऐसा हुआ तो?"));
        ...
        list_of_list_of_phrases.add( Arrays.asList("क्या आपने कभी जागते हुए ये सब कल्पना की है ? ",
        ...
        replacer_list.add(new Replacer(Where.CONTAINS, "क्योंकि", 18));
        ...
        list_of_list_of_phrases.add( Arrays.asList("क्या आप अच्छे दोस्त है?","क्या आपको इस दोस्ती से कुछ मदद हो रही है?", "आपके दोस्त के बारे में मुझे बताइए?"));
        ...
        replacer_list.add(new Replacer(Where.CONTAINS, "विश्वास है", 23));
        ...
        replacer_list.add(new Replacer(Where.CONTAINS, "नहीं", 28));
        replacer_list.add(new Replacer(Where.CONTAINS, "ना", 28));
        replacer_list.add(new Replacer(Where.CONTAINS,"कभी नहीं", 28));
        replacer_list.add(new Replacer(Where.CONTAINS, "ऐसा नहीं है", 28));
        list_of_list_of_phrases.add(Arrays.asList("क्यों नहीं ?", "आप माना क्यों कर रहे हो?", "क्या आप निश्चित हो?"));
        replacer_list.add(new Replacer(Where.CONTAINS, "हा", 29));
        replacer_list.add(new Replacer(Where.CONTAINS, "बिल्कुल सही", 29));
        replacer_list.add(new Replacer(Where.CONTAINS, "सही बात", 29));
        replacer_list.add(new Replacer(Where.CONTAINS, "सही कहा", 29));
        replacer_list.add(new Replacer(Where.CONTAINS, "एकदम सही", 29));
        ...
        replacer_list.add(new Replacer(Where.CONTAINS, "क्या", 33));
        replacer_list.add(new Replacer(Where.CONTAINS, "क्यों", 33));
        replacer_list.add(new Replacer(Where.CONTAINS, "कौन", 33));
        replacer_list.add(new Replacer(Where.CONTAINS, "कब", 33));
        replacer_list.add(new Replacer(Where.CONTAINS, "कहा", 33));
